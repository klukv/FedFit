import { WorkoutService, WorkoutPageContent, workoutCaloriesService, formatWorkoutLevelLabel, getWorkoutImage } from "@/modules/workout";
...
const WorkoutDetailPage = async ({ params, searchParams }: IProps) => {
  ...
  const workoutImage = getWorkoutImage(workoutDetail);
